module.exports = [
"[project]/src/types/gridTrading.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/contexts/GridTradingContext.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$trading$2f$hooks$2f$useGridTradingUI$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/trading/hooks/useGridTradingUI.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
const GridTradingContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createContext"])(null);
const GridTradingProvider = ({ children })=>{
    const gridTrading = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$trading$2f$hooks$2f$useGridTradingUI$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useGridTrading"])({
        currentPrice: 0,
        interval: '60'
    });
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(GridTradingContext.Provider, {
        value: gridTrading,
        children: children
    }, void 0, false, {
...
const useGridTradingContext = ()=>{
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"])(GridTradingContext);
    if (!context) {
...
"[project]/src/hooks/data/useUSDCBalance.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/hooks/data/usePositions.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useUserPositions() {
    ...
    const { data: positionIds, isLoading: isLoadingIds, refetch: refetchIds } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$wagmi$2f$dist$2f$esm$2f$hooks$2f$useReadContract$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useReadContract"])({
        address: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$contracts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["POSITION_MANAGER_ADDRESS"],
...
"[project]/src/hooks/data/usePrices.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function connectWebSocket() {
    ...
    try {
        ...
        const wsUrl = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$contracts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BACKEND_API_URL"].replace(/^http/, 'ws') + '/ws/price';
...
function startPriceStream() {
    ...
    fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$contracts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BACKEND_API_URL"]}/api/price/all`).then((res)=>res.json()).then((result)=>{
...
function usePrice(symbol) {
    const [price, setPrice] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(symbol && sharedPrices[symbol] ? sharedPrices[symbol] : null);
...
function useAllPrices() {
    const [prices, setPrices] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(sharedPrices);
    const [isLoading, setIsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(true);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const updatePrices = ()=>{
            setPrices({
...
"[project]/src/hooks/utils/useDynamicTitle.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/priceApi.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getSignedPrice(symbol) {
    try {
        const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$contracts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BACKEND_API_URL"]}/api/price/signed/${symbol}`, {
            method: 'GET',
            headers: {
...
"[project]/src/lib/relayApi.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function relayTransaction(params) {
    const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$contracts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BACKEND_API_URL"]}/api/relay/transaction`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
async function getLimitExecutionFee(orderType = 'limit_open', options = {}) {
    ...
    const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$contracts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BACKEND_API_URL"]}/api/relay/limit/execution-fee?${params.toString()}`);
    const result = await response.json();
    if (!result.success) {
...
"[project]/src/lib/limitOrderApi.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function submitLimitOpenOrder(payload) {
    const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$contracts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BACKEND_API_URL"]}/api/limit-orders/create`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
"[project]/src/app/trade/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$GridTradingContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/contexts/GridTradingContext.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$trading$2f$contexts$2f$TapToTradeContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/trading/contexts/TapToTradeContext.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$trading$2f$components$2f$trade$2d$content$2f$TradePageContent$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/features/trading/components/trade-content/TradePageContent.tsx [app-ssr] (ecmascript)");
'use client';
;
;
;
...
;
function TradePage() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$trading$2f$contexts$2f$MarketContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MarketProvider"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$GridTradingContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["GridTradingProvider"], {
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$trading$2f$contexts$2f$TapToTradeContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TapToTradeProvider"], {
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$features$2f$trading$2f$components$2f$trade$2d$content$2f$TradePageContent$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                    fileName: "[project]/src/app/trade/page.tsx",
                    lineNumber: 13,
                    columnNumber: 11
                }, this)
            }, void 0, false, {
...
//# sourceMappingURL=src_c187a5ac._.js.map