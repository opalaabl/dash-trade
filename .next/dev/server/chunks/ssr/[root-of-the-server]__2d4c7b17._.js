...
"[externals]/pino [external] (pino, cjs) <export default as pino>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "pino",
    ()=>__TURBOPACK__imported__module__$5b$externals$5d2f$pino__$5b$external$5d$__$28$pino$2c$__cjs$29$__["default"]
]);
...
const USDC_ADDRESS = process.env.NEXT_PUBLIC_USDC_TOKEN_ADDRESS || '0x97e79F7189144F2A67d56ef9164B8230784014cD';
const DASH_TOKEN_ADDRESS = process.env.NEXT_PUBLIC_DASH_TOKEN_ADDRESS || '0xe5A50E831695f4e438fFe877F4970f14778DeB28';
const MARKET_EXECUTOR_ADDRESS = process.env.NEXT_PUBLIC_MARKET_EXECUTOR_ADDRESS || '0x169BD27456DEF7AF81Cee3F188e4C316aF7c3fE5';
const LIMIT_EXECUTOR_ADDRESS = process.env.NEXT_PUBLIC_LIMIT_EXECUTOR_ADDRESS || '0x7690eBE5D0AF8eeBFdF7F18d0De2d4f568a1bf47';
const TAP_TO_TRADE_EXECUTOR_ADDRESS = process.env.NEXT_PUBLIC_TAP_TO_TRADE_EXECUTOR_ADDRESS || '0xb7983AF018547Ef34Af65869cdB2E47264630532';
const POSITION_MANAGER_ADDRESS = process.env.NEXT_PUBLIC_POSITION_MANAGER_ADDRESS || '0x45e985eE1d038d942536270c8662eb5cBFeCa6ef';
const RISK_MANAGER_ADDRESS = process.env.NEXT_PUBLIC_RISK_MANAGER_ADDRESS || '0xB07eFBDd2c31cD97583C91679c9b7B244Db22F0D';
const VAULT_POOL_ADDRESS = process.env.NEXT_PUBLIC_VAULT_POOL_ADDRESS || '0xA880d810Ab6fAc4c60A2b4B8D829fC37f41e2aF9';
const STABILITY_FUND_ADDRESS = process.env.NEXT_PUBLIC_STABILITY_FUND_ADDRESS || '0x1A7763D20C262Faa477C376BFBfE1B712b51D5C8';
const DASH_STAKING_ADDRESS = process.env.NEXT_PUBLIC_DASH_STAKING_ADDRESS || '0x583578f24DCC3f43eefa91bE1a530CBB06faf189';
const USDC_PAYMASTER_ADDRESS = process.env.NEXT_PUBLIC_USDC_PAYMASTER_ADDRESS || '0x8b4AC6b2Dbb9fC97c62C0c086f2932c143DCCc91';
const DEPLOYER_ADDRESS = process.env.NEXT_PUBLIC_DEPLOYER_ADDRESS || '0x722550Bb8Ec6416522AfE9EAf446F0DE3262f701';
const TREASURY_ADDRESS = process.env.NEXT_PUBLIC_TREASURY_ADDRESS || '0x722550Bb8Ec6416522AfE9EAf446F0DE3262f701';
const PRICE_SIGNER_ADDRESS = process.env.NEXT_PUBLIC_PRICE_SIGNER_ADDRESS || '0x722550Bb8Ec6416522AfE9EAf446F0DE3262f701';
...
function getContractAddress(contractName) {
    ...
    for (const [categoryKey, categoryValue] of Object.entries(CONTRACTS)){
        if (contractName in categoryValue) {
            return categoryValue[contractName];
        }
    }
...
"[project]/src/contexts/TPSLContext.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const TPSLContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createContext"])(undefined);
function TPSLProvider({ children }) {
    ...
    const [lastFetch, setLastFetch] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(0);
    const fetchAll = async ()=>{
        ...
        setIsLoading(true);
        try {
            const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$contracts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BACKEND_API_URL"]}/api/tpsl/all`);
    ...
    const getConfig = (positionId)=>{
        return configs[positionId] || null;
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(TPSLContext.Provider, {
        value: {
            configs,
            isLoading,
            refresh: fetchAll,
        ...
        fileName: "[project]/src/contexts/TPSLContext.tsx",
        lineNumber: 88,
        columnNumber: 5
    }, this);
}
function useTPSLContext() {
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useContext"])(TPSLContext);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-dev-runtime.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$privy$2d$io$2f$react$2d$auth$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@privy-io/react-auth/dist/esm/index.mjs [app-ssr] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$privy$2d$io$2f$wagmi$2f$dist$2f$esm$2f$WagmiProvider$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@privy-io/wagmi/dist/esm/WagmiProvider.mjs [app-ssr] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$TPSLContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/contexts/TPSLContext.tsx [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function Providers({ children }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$privy$2d$io$2f$react$2d$auth$2f$dist$2f$esm$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["PrivyProvider"], {
        ...
        config: {
            ...
            defaultChain: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$chains$2f$definitions$2f$baseSepolia$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["baseSepolia"],
            supportedChains: [
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$viem$2f$_esm$2f$chains$2f$definitions$2f$baseSepolia$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["baseSepolia"]
            ]
        },
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["QueryClientProvider"], {
            client: queryClient,
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$privy$2d$io$2f$wagmi$2f$dist$2f$esm$2f$WagmiProvider$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["WagmiProvider"], {
                config: config,
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$contexts$2f$TPSLContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TPSLProvider"], {
                    children: [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2d4c7b17._.js.map