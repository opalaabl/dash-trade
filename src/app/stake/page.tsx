...
export default function StakePage() {
  ...
  return (
    ...
    >
      <div className="mb-8">
        <h1 className="text-4xl font-bold mb-2">Stake DASH</h1>
              ...
              <tr className="hover:bg-slate-800/30 transition-colors">
                <td className="px-6 py-4">
                  <div className="flex items-center gap-3">
                    ...
                    />
                    <span className="font-medium text-white">DASH</span>
                  </div>
                </td>
                <td className="px-6 py-4">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-400 text-sm mb-6">
          DASH revenue is paid directly in the underlying collateral.
        </p>
